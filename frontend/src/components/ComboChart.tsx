...
export function ComboChart({ history }: Props) {
  const option = {
    ...
    yAxis: [
      { type: 'value', name: 'CS/s', splitLine: { lineStyle: { color: '#334155' } }, nameTextStyle: { color: '#94A3B8', fontSize: 9 }, axisLabel: { color: '#94A3B8', fontFamily: 'Space Grotesk, monospace', fontSize: 9 } },
      { type: 'value', name: 'MISS %', splitLine: { show: false }, alignTicks: true, position: 'right', nameTextStyle: { color: '#94A3B8', fontSize: 9 }, axisLabel: { color: '#94A3B8', fontFamily: 'Space Grotesk, monospace', fontSize: 9 } }
    ],
    series: [
      {
